    ...
    >
      <Box
        sx={{
          ...
          top: 120,
          height: "fit-content",
          position: "sticky", // ✅ Added sticky positioning for sidebar
        }}
      >
        <Toggles
          breeds={breeds}
              ...
              <CardContent>
                ...
                <Grid container spacing={2}>
                  <Grid item xs={6} md={3}>
                    ...
                    <Typography>{breed.weight?.metric || "N/A"} kg</Typography>
                  </Grid>

                  <Grid item xs={6} md={3}>
                    <Typography variant="subtitle2">Height</Typography>
                    <Typography>{breed.height?.metric || "N/A"} cm</Typography>
                  </Grid>

                  <Grid item xs={6} md={3}>
                    <Typography variant="subtitle2">Country Code</Typography>
                    <Typography>{breed.country_code || "N/A"}</Typography>
                  </Grid>
                ...
                <Divider sx={{ my: 2 }} />
                  ...
                  <Typography color="text.secondary">
                    {breed.history || "No history available."}
                  </Typography>
              </CardContent>
            </Card>
          ))
